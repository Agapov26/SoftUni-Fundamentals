...
namespace _05._Multiply_Number
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(MultyplyNumbers(bigNumber, multiplyNumber));
        }

        private static string MultyplyNumbers(string bigNumber, string multiplyNumber)
        {
